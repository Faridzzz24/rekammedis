...
<div class="card">
    ...
    @else
    <table class="tbl">
        <thead><tr><th>Nama</th><th>Tipe</th><th>Alamat</th><th>Telepon</th><th>Jumlah Dokter</th><th></th></tr></thead>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="actions">
                        ...
                        <form method="POST" action="{{ route('hospitals.destroy', $h) }}" onsubmit="return confirm('Hapus rumah sakit ini?')">
                            @csrf @method('DELETE')
